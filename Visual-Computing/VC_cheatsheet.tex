...
\definecolor{brandblue}{rgb}{0.169, 0.404, 0.886}
...
\end{center}
\begin{center}
    \includegraphics[width=\linewidth]{./Figures/fourier-transforms.jpeg}
\end{center}
...
\subsubsection{MPEG Group of Pictures (GOP)} Starts with I-frame, ends with B-frame (\say{open}) or P-frame (\say{closed}).
\begin{itemize}
...
\begin{figure}[H]
    \center
    \includegraphics[width=0.75\linewidth]{./Figures/radon-image-reconstruction.jpeg}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=\linewidth]{./Figures/radon-back-projection.jpeg}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{./Figures/ciergb.jpeg}
\end{figure}
...
\subsubsection{HSV}
Hue, saturation, value. Dimensions correspond to natural notions of \say{characteristics} of color. Useful for color picking.
...
\begin{tabular}{m{3cm}r}
    \includegraphics[width=3cm]{./Figures/coord-system-change.jpeg}
&
$
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\linewidth]{./Figures/lamberts-law.jpeg}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\linewidth]{./Figures/phong-shading.jpeg}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{./Figures/transparency.jpeg}
\end{figure}
...
\begin{figure}[h]
    \center
    \includegraphics[width=0.75\linewidth]{./Figures/bresenham-line.jpeg}
\end{figure}
