...
\say{Plain} distance measure \(I_\alpha = |I - g| > T\) with threshold \(T\) and root color \(g = (c_r, c_g, c_b)\) is simplest variant of chromakeying, however it does not account for different variations in the individual channels and produces a hard alpha mask. Instead define distance as ellipsoid in RGB space.
